...
import { EDITORIAL_BAND } from "@/lib/constants";
  ...
  return (
    <section className="relative w-full bg-bamboo-dark" aria-label="Frase inspiracional">
      <button
        ...
        className="group block w-full cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-earth-light"
